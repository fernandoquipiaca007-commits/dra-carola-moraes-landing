...
import logoImg from '../assets/logo Carola Moraes.jpeg';
...
export function Hero() {
  ...
  const WhatsAppGroupLink = "https://chat.whatsapp.com/JSZohWB6ZQ9G19OFavoZhz?s=cl&p=i&mlu=4&ilr=4";
  ...
  return (
    <section className="relative pt-6 pb-20 px-6 md:px-12 bg-[#faf4f5] max-w-[1280px] mx-auto flex flex-col items-center">

      {/* Header Logo */}
      <div className="flex justify-center pt-6 pb-8 w-full border-b border-[#861a32]/10">
        <img
          src={logoImg}
          alt="Carola Moraes Logo"
          className="h-44 md:h-56 lg:h-64 w-auto object-contain rounded-xl shadow-xs"
        />
      </div>
      ...
      <div className="w-full max-w-4xl text-center space-y-4 pt-6">
        ...
        {/* Event details */}
        <div className="text-[#861a32] font-extrabold text-sm md:text-base tracking-wide pt-2">
      ...
      <div className="w-full max-w-[520px] mt-10">
        <div
          id="inscricao"
          className="bg-white border-2 border-[#861a32] rounded-[24px] p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.06)]"
        >
          <AnimatePresence mode="wait">
              ...
              >
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <label htmlFor="name-input" className="block text-xs font-semibold text-[#1e0a10] uppercase tracking-wider ml-1">
                      Nome*
                    </label>
                    <input
                      required
                  ...
                  {/* Email Input */}
                  <div className="space-y-1">
                    <label htmlFor="email-input" className="block text-xs font-semibold text-[#1e0a10] uppercase tracking-wider ml-1">
                      Email*
                    </label>
                    <input
                      required
                  ...
                  {/* WhatsApp Input */}
                  <div className="space-y-1">
                    <label htmlFor="whatsapp-input" className="block text-xs font-semibold text-[#1e0a10] uppercase tracking-wider ml-1">
                      Whatsapp*
                    </label>
                    <input
                      required
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      className="w-full bg-[#861a32] hover:bg-[#540d1e] text-white font-bold py-4 px-6 rounded-lg uppercase tracking-wider transition-all duration-200 cursor-pointer shadow-md text-sm md:text-base"
                    >
                      QUERO PARTICIPAR
                    </button>
                  </div>
                ...
                {/* Privacy Warning */}
                <p className="text-center text-[10px] md:text-xs text-[#1e0a10]/60 font-light leading-relaxed">
            ...
            {formState === 'loading' && (
              ...
              >
                <Loader2 className="w-8 h-8 text-[#861a32] animate-spin" strokeWidth={2} />
                <p className="text-[#1e0a10] font-medium text-sm">Registrando sua vaga de forma segura...</p>
              </motion.div>
            )}
            ...
            {formState === 'success' && (
              ...
              >
                ...
                <h3 className="font-serif text-2xl text-[#1e0a10] font-semibold">
                  Inscrição Confirmada!
                </h3>
                <p className="text-xs md:text-sm text-[#1e0a10]/80 leading-relaxed max-w-sm">
      ...
      <div className="w-full max-w-2xl text-center mt-8 space-y-2">
        ...
        <div className="pt-6">
          <button
            ...
            className="w-full max-w-[480px] bg-[#861a32] hover:bg-[#540d1e] text-white font-bold py-5 px-8 rounded-xl uppercase tracking-wider transition-all duration-200 cursor-pointer shadow-lg hover:shadow-xl text-sm md:text-base leading-snug"
          >
